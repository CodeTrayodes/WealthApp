...
const OnboardingPrompt = () => {
  const onboardingSteps = [
    {
      ...
      description: 'Upload your passport, PAN card, and Aadhaar for identity verification',
    ...
    },
    {
      ...
      description: 'Provide address proof, income documents, and NRI status verification',
    ...
    },
    {
      ...
      description: 'Complete risk profiling to get personalized investment recommendations',
  ...
  const lockedFeatures = [
    {
      ...
      description: 'Track and manage your investments across multiple asset classes',
      icon: <ChartBarIcon className="w-8 h-8" />,
      highlight: true
    },
    {
      title: 'Family Wealth Tracking',
      description: 'Monitor family member portfolios and set investment permissions',
      icon: <UserGroupIcon className="w-8 h-8" />,
      highlight: false
    },
    {
      title: 'Investment Opportunities',
      description: 'Access curated investment options tailored for NRI investors',
  ...
  return (
    <div className="space-y-8">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Unlock access to India's most advanced NRI investment platform. Complete KYC verification 
            to start building wealth with AI-powered insights and family portfolio management.
          </p>
      ...
      >
        <h3 className="text-2xl font-bold text-white mb-6">Complete in 4 Simple Steps</h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-2">
                    <h4 className="text-white font-semibold">Step {step.step}: {step.title}</h4>
        ...
        <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-xl">
          <div className="flex items-center space-x-2 text-yellow-500 mb-2">
            ...
            <span className="font-semibold text-sm">Total Time: ~25 minutes</span>
          </div>
          <p className="text-gray-300 text-sm">
            Complete all steps in one session or save your progress and continue later.
          </p>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="bg-gray-900 rounded-3xl p-6 border border-gray-800"
      >
        <h3 className="text-2xl font-bold text-white mb-6">What You'll Unlock</h3>
            ...
            >
              ...
              <div className="opacity-30">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${
                  feature.highlight ? 'bg-yellow-500 text-black' : 'bg-gray-700 text-gray-400'
                }`}>
                  {feature.icon}
                </div>
      ...
      <motion.div
        ...
        className="bg-gray-900 rounded-3xl p-6 border border-gray-800"
      >
        <h3 className="text-2xl font-bold text-white mb-6">Exclusive NRI Benefits</h3>
      ...
      >
        ...
        <p className="text-gray-400 mb-6">
          Our NRI specialists are available 24/7 to guide you through the onboarding process.
        </p>
