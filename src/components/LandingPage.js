...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section
        id="hero"
        className="relative min-h-screen flex items-center justify-center bg-lines overflow-hidden"
      >
        ...
        <div className="relative z-20 text-center max-w-7xl mx-auto px-4 w-full">
          ...
          <div className="h-40 md:h-64 lg:h-80 xl:h-96 flex items-center justify-center mb-8">
            <AnimatePresence mode="wait">
              <motion.h1
                ...
                style={{
                  textShadow:
                    "0 0 40px rgba(255, 229, 0, 0.4), 0 0 80px rgba(255, 229, 0, 0.2)",
          ...
          >
            <div className="flex flex-col items-center space-y-3">
              <span className="text-yellow-500 text-xs font-medium tracking-[0.2em] uppercase">
                PLEASE SCROLL
              </span>
              <motion.div
      ...
      <section className="relative">
        <div className="bg-white text-black rounded-t-[3rem] md:rounded-t-[4rem] lg:rounded-t-[5rem] relative z-10 -mt-16 md:-mt-20 lg:-mt-24">
          <div className="container-main section-spacing">
            ...
            >
              <h2 className="text-yellow-500 text-sm font-medium tracking-widest mb-6 uppercase">
                Welcome to the Future of NRI Wealth Management
              </h2>

              <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-8 leading-tight">
                India&apos;s Most{" "}
                <span className="text-yellow-500">Intelligent</span> Investment
                Platform for HNI NRIs
              </h3>

              <p className="text-gray-600 text-lg md:text-xl mb-12 leading-relaxed max-w-4xl mx-auto">
                We&apos;re building the future of wealth management with
                AI-powered insights, 100+ years of Mumbai family office
                expertise, and cutting-edge technology that makes investing in
                India effortless for high-net-worth NRI families worldwide.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Advanced algorithms and machine learning drive personalized
                ...
                >
                  ...
                  <p className="text-gray-600">
                    100+ years of Mumbai family office experience in Indian
                    investment markets
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Unified dashboards and tracking for entire family wealth
                    management
                  </p>
                </motion.div>
              </div>
          ...
          <div className="container-main section-spacing">
            ...
            >
              ...
              <h3 className="text-4xl md:text-5xl font-bold text-white mb-8 leading-tight">
                ...
                <span className="text-yellow-500">Tradition & Innovation</span>
              </h3>
              <p className="text-gray-400 text-lg max-w-3xl mx-auto">
                We combine century-old investment wisdom with cutting-edge AI
                technology to deliver superior returns and seamless user
                experience.
              </p>
            </motion.div>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Our AI-driven strategies have consistently outperformed
                      market indices, delivering exceptional returns for our
                      clients.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Real-time portfolio tracking, detailed reports, and full
                      visibility into every investment decision and fee
                      structure.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Unified dashboards for entire families, enabling
                      collaborative wealth management and transparent sharing
                      across generations.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Deep understanding of both international markets and
                      Indian investment landscape, optimized for NRI needs.
                    </p>
                  </div>
                </motion.div>
              </div>
  ...
  &ldquo;The most intuitive and powerful wealth management platform I&apos;ve ever used. Finally, a solution built specifically for NRI families.&rdquo;
</p>
                  <p className="text-gray-400 text-xs text-center mt-2">
                    - Priya Sharma, Silicon Valley Executive
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        <div className="bg-white text-black rounded-t-[3rem] md:rounded-t-[4rem] lg:rounded-t-[5rem] relative z-10 -mt-16 md:-mt-20 lg:-mt-24">
          <div className="container-main section-spacing">
            ...
            >
              ...
              <h3 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black mb-8 leading-tight">
                Get <span className="text-yellow-500">Early Access</span> to
                WealthBridge
              </h3>

              <p className="text-gray-600 text-lg md:text-xl mb-12 leading-relaxed">
                Be among the first to experience our revolutionary AI-powered
                investment platform. Limited spots available for our exclusive
                beta program.
              </p>
        ...
        <div className="container-main">
          ...
          <div className="mt-6 pt-6 border-t border-gray-900 text-center">
            <p className="text-gray-500 text-sm">
              © 2025 WealthBridge. Built with precision for HNI NRI families.
              Mumbai • New York • London • Singapore
            </p>
          </div>
        </div>
      </footer>
